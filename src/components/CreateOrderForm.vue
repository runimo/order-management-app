...
import type { OrderDraft } from '@/types/index.d.ts'

const ordersStore = useOrdersStore()
const { createOrder, resetOrderByType } = ordersStore
const { orderBeingCreated } = storeToRefs(ordersStore)
      ...
      <div class="w-[90%] md:w-[50%] md:justify-end rounded-xs border border-gray-300 mt-4 p-4">
          ...
          <div class="flex items-center w-[90%]">
            ...
            >
              ...
              <div
                ...
                :class="[
                  step === 'Confirm' ? 'left-[-3px]' : 'left-[-20px]',
        ...
        <div v-if="currentStep === 1">
          ...
          <div class="flex flex-col sm:flex-row justify-end w-full mt-6">
            <BaseButton class="w-full sm:w-[30%] sm:mr-2" variant="secondary" @click="cancel">
              Cancel
            </BaseButton>
            <BaseButton
        ...
        <div v-if="currentStep === 2">
          ...
          <div class="flex flex-col sm:flex-row justify-between w-full mt-6">
            <BaseButton class="w-full sm:w-[30%]" variant="secondary" @click="handleBack">
              Back
            </BaseButton>
            <BaseButton
              class="w-full sm:w-[30%]"
        ...
        <div v-if="currentStep === 3">
          <div>
            ...
            <div class="text-right mt-4 mr-1">
              ...
              <span> {{ orderBeingCreated?.totalPrice }} € </span>
            </div>
          </div>
          ...
          <div class="flex flex-col sm:flex-row justify-between w-full gap-2 mt-6">
            ...
            <BaseButton class="w-full sm:w-[30%]" @click="handleCreateOrder">
              Create Order
            </BaseButton>
          </div>
        </div>
